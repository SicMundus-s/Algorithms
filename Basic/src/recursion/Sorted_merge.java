 ...
 * отсортировать каждую половину, а затем воспользоваться методом merge() для слияния двух половин в один отсортированный массив.
 ...
 Делает то же самое для правой части массива и ->
